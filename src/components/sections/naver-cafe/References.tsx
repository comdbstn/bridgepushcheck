...
const references = [
    "/images/references/cafe1.png",
    "/images/references/cafe2.png",
    "/images/references/cafe3.png",
    "/images/references/cafe4.png",
    "/images/references/cafe5.png",
    "/images/references/cafe6.png",
    "/images/references/cafe7.png",
    "/images/references/cafe8.png",
    "/images/references/cafe9.png"
];
    ...
    return (
        <section className='py-20 bg-gradient-to-br from-[#E5FFE8] to-white'>
            <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                >
                    브릿지마케팅의 네이버 카페 마케팅 성공 사례를 소개합니다
                </motion.p>
